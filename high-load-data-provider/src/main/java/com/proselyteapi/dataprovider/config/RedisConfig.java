...
//@EnableCaching
//@EnableAsync
//@EnableRedisRepositories(basePackageClasses = {CompanyRepository.class, StockRepository.class})
...
//                .transactionAware()
//                .cacheWriter(RedisCacheWriter.nonLockingRedisCacheWriter(factory, BatchStrategies.scan(1000)))
//                .build();
//    }
//}