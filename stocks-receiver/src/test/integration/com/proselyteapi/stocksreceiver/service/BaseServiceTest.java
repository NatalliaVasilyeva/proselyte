...
import com.proselyteapi.stocksreceiver.StocksReceiverApplication;
...
@SpringBootTest(classes = {
    StocksReceiverApplication.class,
...
public abstract class BaseServiceTest {
    ...
    private static final PostgreSQLContainer<?> container = new PostgreSQLContainer<>()
        .withDatabaseName("stocks-receiver-test")
        .withUsername("stocks-receiver-test")
        .withPassword("stocks-receiver-test")
